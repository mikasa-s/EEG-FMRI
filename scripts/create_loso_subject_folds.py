...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", required=True, help="Directory for fold manifests")
    parser.add_argument("--config-dir", required=True, help="Directory for fold config files")
    parser.add_argument(
        "--contrastive-template",
        default="configs/train_contrastive_ds002336_binary_block.yaml",
        help="Base contrastive config template",
    )
    parser.add_argument(
        "--finetune-template",
        default="configs/finetune_classifier_ds002336_binary_block.yaml",
...
def update_fold_configs(
    ...
    contrastive_cfg["train"]["output_dir"] = f"outputs/contrastive_ds002336_binary_block_loso/{fold_name}"
    finetune_cfg["finetune"]["output_dir"] = f"outputs/finetune_ds002336_binary_block_loso/{fold_name}"
